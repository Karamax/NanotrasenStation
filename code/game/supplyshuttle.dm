...
/obj/structure/plasticflaps/CanPass(atom/A, turf/T)
	...
	if (istype(A, /obj/structure/stool/bed) && B.buckled_mob)//if it's a bed/chair and someone is buckled, it will not pass
		...
		var/mob/living/M = A
		if(!M.lying && !istype(M, /mob/living/carbon/monkey) && !istype(M, /mob/living/carbon/slime) && !istype(M, /mob/living/carbon/brain) && !istype(M, /mob/living/simple_animal))	//If your not laying down, or a small creature, no pass.
			return 0
	return ..()
